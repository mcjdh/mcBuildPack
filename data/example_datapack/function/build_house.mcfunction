...
# Build foundation (stone base)
fill ~1 ~-1 ~1 ~7 ~-1 ~5 cobblestone
...
# Place wall torches for proper lighting
setblock ~2 ~2 ~2 wall_torch[facing=south]
setblock ~6 ~2 ~2 wall_torch[facing=south]
setblock ~3 ~2 ~4 wall_torch[facing=north]
setblock ~5 ~2 ~4 wall_torch[facing=north]